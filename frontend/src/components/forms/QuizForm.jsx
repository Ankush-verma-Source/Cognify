...
const QuizForm = ({ selectedModel }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append('quizType', formRef.current.quizType.value);
        ...
        formData.append('focusArea', formRef.current.focusArea.value);
        ...
        try {
            const response = await api.post('/user/generate/quiz', formData, {
                headers: {
    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="space-y-2">
                    <label htmlFor="quiz-type" className="block text-sm font-medium text-slate-300">
                        Quiz Type
                    </label>
                    <select
                        id="quiz-type"
                ...
                <div className="space-y-2">
                    <label htmlFor="focus-area" className="block text-sm font-medium text-slate-300">
                        Focus Area
                    </label>
                    <select
                        id="focus-area"
                        ...
                        className="w-full bg-slate-950 border border-slate-800 focus:border-indigo-500/50 rounded-xl py-3 px-4 text-slate-200 focus:outline-none transition-all appearance-none cursor-pointer"
                    >
                        <option value="concepts">Core Concepts (Why/How)</option>
                        <option value="facts">Memorization & Facts (What/When)</option>
                ...
                <div className="space-y-2">
                    ...
                    >
                        ...
                        <option value="scenario">Scenario / Case Study Based</option>
            ...
            <div className="space-y-2">
                ...
                <textarea
                    ...
                    rows="3"
                    placeholder="e.g. Include specific focus on chapter 4, make it more practical..."
